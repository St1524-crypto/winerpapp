/**
 * 依名冊覆蓋會員折扣點（member_points_wallet.discount_points）
 * 用法：bun scripts/import_discount_pointss.ts <pairs.json> [--apply]
 */
