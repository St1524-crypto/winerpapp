/**
 * 依名冊覆蓋會員購物點（member_points_wallet.shopping_points）
 * 用法：bun scripts/import_shopping_pointss.ts <pairs.json> [--apply]
 */
