/**
 * 依名冊覆蓋會員現金餘額（member_points_wallet.cash_balance）
 * 用法：bun scripts/import_cash_balances.ts <pairs.json> [--apply]
 */
