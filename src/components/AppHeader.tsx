...
import { Search, LogOut, User, Shield, LayoutDashboard, Store } from "lucide-react";
...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-2 md:gap-3 border-b border-border bg-background/80 backdrop-blur-xl px-3 md:px-6">
      <SidebarTrigger />
