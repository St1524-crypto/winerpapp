    ...
    <div className="space-y-6 max-w-6xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
          <Crown className="h-6 w-6 text-primary" />VIP階級管理
        </h1>
          ...
          <Card key={t.code} className="relative">
            ...
            <CardContent className="text-sm space-y-2">
              ...
              <ul className="text-xs space-y-1 ml-1">
                ...
                {t.operating_bonus_rate > 0 && <li>• 消費回饋 {t.operating_bonus_rate}%</li>}
                {t.upgrade_bonus_cap > 0 && <li>• 消費回饋上限 NT$ {t.upgrade_bonus_cap.toLocaleString()}</li>}
          ...
          {editing && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Field label="消費回饋率 %"><Input type="number" step="0.01" value={editing.operating_bonus_rate} onChange={(e) => setEditing({ ...editing, operating_bonus_rate: +e.target.value })} /></Field>
                <Field label="消費回饋上限"><Input type="number" value={editing.upgrade_bonus_cap} onChange={(e) => setEditing({ ...editing, upgrade_bonus_cap: +e.target.value })} /></Field>
