...
REVOKE EXECUTE ON FUNCTION public.resolve_bonus_reward_recipient(uuid) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.resolve_bonus_reward_recipient(uuid) FROM anon;
REVOKE EXECUTE ON FUNCTION public.resolve_bonus_reward_recipient(uuid) FROM authenticated;
...
REVOKE EXECUTE ON FUNCTION public.release_bonus_rewards(uuid[], integer) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.release_bonus_rewards(uuid[], integer) FROM anon;
REVOKE EXECUTE ON FUNCTION public.release_bonus_rewards(uuid[], integer) FROM authenticated;
