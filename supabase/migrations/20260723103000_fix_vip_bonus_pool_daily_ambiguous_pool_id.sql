...
--
-- Purpose:
--   public.distribute_vip_bonus_pool_daily(...) RETURNS TABLE includes output
--   columns named pool_id and payout_date. The idempotency EXISTS query used
--   unqualified column names against vip_bonus_pool_payouts, which can raise:
--   "column reference \"pool_id\" is ambiguous".
--
-- Safety:
--   - Rewrites function text only.
